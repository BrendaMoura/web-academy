import { TV, Celular, Bicicleta, Item, Cart } from "./model/Classes.js";
const productList = document.getElementById("list");
const cartList = document.getElementById("cart-items");
const btnClearCart = document.getElementById("clear-cart");
const btnFinishCart = document.getElementById("finish-cart");
const list_products = [];
const cart = new Cart([]);
const loadProducts = () => {
...
btnFinishCart.addEventListener("click", () => {
    ...
    alert(`Obrigada por comprar nossos produtos, sua compra deu R$${getCartTotal()}!`);
    clearCart();
});
loadProducts();
loadList();
